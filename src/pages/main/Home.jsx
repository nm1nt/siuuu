          ...
          <div className="flex flex-col items-center sm:px-5 md:flex-row">
            <div className="w-full md:w-1/2">
              <a href="#_" className="block">
                <img className="object-cover w-full h-full rounded-lg max-h-64 sm:max-h-96" src={dataStore.image} />
              </a>
            </div>
            <div className="flex flex-col items-start justify-center w-full h-full py-6 mb-6 md:mb-0 md:w-1/2">
              <div className="flex flex-col items-start justify-center h-full space-y-3 transform md:pl-10 lg:pl-16 md:space-y-5">
                ...
                <h1 className="text-4xl font-bold leading-none lg:text-5xl xl:text-6xl "><a className="text-black" href="#_">{dataStore.place}</a><a href={'detail1'}>Logis De France Paris</a></h1>
            ...
            {dataStore.map((item, index) => {
              return index == 0 ? "" : (
                <div className="flex flex-col items-start col-span-12 space-y-3 sm:col-span-6 xl:col-span-4">
                  ...
                  <p className="text-sm text-gray-500">{item.description}     <a href={'detail2'}>CLICK HERE</a></p>
