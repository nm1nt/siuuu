          ...
          <div className="flex flex-col items-center sm:px-5 md:flex-row">
            ...
            <div className="flex flex-col items-start justify-center w-full h-full py-6 mb-6 md:mb-0 md:w-1/2">
              <div className="flex flex-col items-start justify-center h-full space-y-3 transform md:pl-10 lg:pl-16 md:space-y-5">
                ...
                <h1 className="text-4xl font-bold leading-none lg:text-5xl xl:text-6xl "><a className="text-black underline" href="#_">{dataStore[0].place}</a></h1>
                <p className="pt-2 text-sm font-medium">{dataStore[0].address} · <span className="mx-1">April 23rd, 2021</span> · <span className="mx-1 text-gray-600">5 min. read</span></p>
              </div>
            </div>
          </div>
