...
<div>
    ...
    <div class="box-border flex flex-col items-center content-center px-8 mx-auto leading-6 text-black border-0 border-gray-300 border-solid md:flex-row max-w-7xl lg:px-16">
        ...
        <div class="box-border relative w-full max-w-md px-4 mt-5 mb-4 -ml-5 text-center bg-no-repeat bg-contain border-solid md:ml-0 md:mt-0 md:max-w-none lg:mb-0 md:w-1/2 xl:pl-10">
            <img src="https://www.kynghidongduong.vn/userfiles/images/tour-nuoc-ngoai/dubai/burj-al-arab-du-lich-dubai-kynghidongduong-011.jpg" />
        </div>
...
2. Mọi thứ trong khách sạn từ sàn, tường, thậm chí đồ trang trí, nội thất đều được làm bằng vàng và đá cẩm thạch. Thậm chí trần của nhà hàng trong khách sạn còn được làm từ pha lê Swarovski.
        ...
        <div class="box-border relative w-full max-w-md px-4 mt-10 mb-4 text-center bg-no-repeat bg-contain border-solid md:mt-0 md:max-w-none lg:mb-0 md:w-1/2">
            <img src="https://www.kynghidongduong.vn/userfiles/images/tour-nuoc-ngoai/dubai/burj-al-arab-du-lich-dubai-kynghidongduong-022.jpg" />
        </div>
    </div>
    <div class="box-border flex flex-col items-center content-center px-8 mx-auto leading-6 text-black border-0 border-gray-300 border-solid md:flex-row max-w-7xl lg:px-16">
        ...
        {/* <!-- Image --> */}
        <div class="box-border relative w-full max-w-md px-4 mt-5 mb-4 -ml-5 text-center bg-no-repeat bg-contain border-solid md:ml-0 md:mt-0 md:max-w-none lg:mb-0 md:w-1/2 xl:pl-10">
            <img src="https://www.kynghidongduong.vn/userfiles/images/tour-nuoc-ngoai/dubai/burj-al-arab-du-lich-dubai-kynghidongduong-010.jpg" />
        </div>
...
9. Có một sân bay trực thăng rộng 24 mét nằm cách tòa nhà 210 mét so với mặt đất. Khách đặt phòng ở đây được đưa đón bằng ô tô hoặc trực thăng riêng. 
        ...
        {/* <!-- Image --> */}
        <div class="box-border relative w-full max-w-md px-4 mt-10 mb-4 text-center bg-no-repeat bg-contain border-solid md:mt-0 md:max-w-none lg:mb-0 md:w-1/2">
            <img src="https://www.kynghidongduong.vn/userfiles/images/tour-nuoc-ngoai/dubai/burj-al-arab-du-lich-dubai-kynghidongduong-025.jpg" />
        </div>
    </div>
    <div class="box-border flex flex-col items-center content-center px-8 mx-auto leading-6 text-black border-0 border-gray-300 border-solid md:flex-row max-w-7xl lg:px-16">
        ...
        {/* <!-- Image --> */}
        <div class="box-border relative w-full max-w-md px-4 mt-5 mb-4 -ml-5 text-center bg-no-repeat bg-contain border-solid md:ml-0 md:mt-0 md:max-w-none lg:mb-0 md:w-1/2 xl:pl-10">
            <img src="https://www.kynghidongduong.vn/userfiles/images/tour-nuoc-ngoai/dubai/burj-al-arab-du-lich-dubai-kynghidongduong-023.jpg" />
        </div>
